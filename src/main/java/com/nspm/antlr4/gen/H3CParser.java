...
//		System.out.println(_localctx.depth());
//		System.out.println(_localctx.toString());
...
//		System.out.println(_localctx.toString());
	...
	public final CommandLineContext commandLine() throws RecognitionException {
		...
		if(_localctx.knownCommand()!=null ){
			List<TerminalNode> lst = _localctx.knownCommand().contextRule().INT();
			for (TerminalNode node: lst
			) {
